    ...
    <table border="0" width="920" cellspacing="0" cellpadding="0" bgcolor="white">
                            ...
                            <td align="right" background="images/menu.gif">
                                ...
                                <table border="0" width="600">
                                    <tr align="center">
                                        ...
                                        <td width="100"><a href="info_ListShow.action?infoType=1" style="color:white">招聘信息</a>
                                        </td>


                                        <td width="100"><a href="info_ListShow.action?infoType=2" style="color:white">培训信息</a>
                                        </td>
        ...
        <tr>
            ...
            <td width="690" height="400" align="center" valign="top" bgcolor="#FFFFFF">
                ...
                <head>
                    <title>发布信息</title>
                    <script type="text/javascript" src="js/InputCheck.js?addType=linkTo"></script>
                </head>
                <body>
                <center>
                    <table border="0" cellpadding="0" cellspacing="0" width="688" height="100%">
                        ...
                        <tr>
                            <td background="images/default_m.jpg" valign="top" align="center">
                                ...
                                <form id="info_Add_action" name="info_Add.action" onSubmit="return true;"
                                      action="/01/info_Add.action" method="post">
                                            ...
                                            <td align="center">
                                                <table border="0" width="650" rules="all" cellspacing="8">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <select name="infoSingle.infoType"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2"><input type="text" name="infoSingle.infoTitle"
                                                                               size="80" maxlength="40" value=""
                                                                               id="info_Add_action_infoSingle_infoTitle"/>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="3"></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <font color="#7F7F7F">
                                                                已用：<input type="text" name="ContentUse" value="0"
                                                                          size="4" disabled
                                                                          style="text-align:center;border:0;"> 个&nbsp;&nbsp;
                                                                剩余：<input type="text" name="ContentRem" value="500"
                                                                          size="4" disabled
                                                                          style="text-align:center;border:0;"> 个
                                                            </font>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td colspan="3" align="center"><textarea
                                                                name="infoSingle.infoContent" cols="85" rows="12"
                                                                id="content"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2"><input type="text" name="infoSingle.infoPhone"
                                                                               size="45" value=""
                                                                               id="info_Add_action_infoSingle_infoPhone"/><font
                                                                color="gray">&nbsp;[多个电话以逗号分隔！]</font></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="3"></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td colspan="2"><input type="text" name="infoSingle.infoLinkman"
                                                                               size="50" value=""
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2"><input type="text" name="infoSingle.infoEmail"
                                                                               size="55" value=""
